...
@SuppressWarnings({"LongLine", "WeakerAccess"})
public class AndroidSystemPatcher {
    ...
    public static void fixKitKatMovingHomeFrontBug(final LoadPackageParam lp) throws Throwable {
