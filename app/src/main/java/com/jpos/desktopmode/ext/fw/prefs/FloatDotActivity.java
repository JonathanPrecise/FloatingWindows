...
//														new FloatDotFragment()).commit();
	...
	private void sendRefreshCommand(String key){
		...
		String mColor = null;
		switch (key) {
			case Common.KEY_FLOATDOT_COLOR_OUTER1:
				item = 0;
				break;
			case Common.KEY_FLOATDOT_COLOR_INNER1:
				item = 1;
				break;
			case Common.KEY_FLOATDOT_COLOR_OUTER2:
				item = 2;
				break;
			case Common.KEY_FLOATDOT_COLOR_INNER2:
				item = 3;
				break;
			case Common.KEY_FLOATDOT_SINGLE_COLOR_SNAP:
				item = 1;
				...
				break;
			case Common.KEY_FLOATDOT_SINGLE_COLOR_LAUNCHER:
				item = 3;
				...
				break;
			case Common.KEY_FLOATDOT_SIZE:
				size = mPref.getInt(key, Common.DEFAULT_FLOATDOT_SIZE);
				break;
			case Common.KEY_FLOATDOT_ALPHA:
